	...
	*/
    ...
    Scroller.prototype = {
        ...
        getUnionExtremes: function(returnFalseOnNoBaseSeries) {
            ...
            if (!returnFalseOnNoBaseSeries || baseAxis.dataMin !== null) {
                return {
                    dataMin: pick(
                        navAxisOptions && navAxisOptions.min, ((defined(baseAxis.dataMin) && defined(navAxis.dataMin)) ? mathMin : pick)(baseAxis.dataMin, navAxis.dataMin)
                    ),
                    dataMax: pick(
                        navAxisOptions && navAxisOptions.max, ((defined(baseAxis.dataMax) && defined(navAxis.dataMax)) ? mathMax : pick)(baseAxis.dataMax, navAxis.dataMax)
                    )
                };
            }
    ...
    Point.prototype.tooltipFormatter = function(pointFormat) {
        ...
        pointFormat = pointFormat.replace(
            '{point.change}', (point.change > 0 ? '+' : '') + numberFormat(point.change, point.series.tooltipOptions.changeDecimals || 2)
        );
